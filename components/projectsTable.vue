              ...
              <tr v-for="proyecto in proyectos" :key="proyecto.id" class="bg-white transition-all duration-500 hover:bg-gray-100">
                ...
                <td class="p-5 whitespace-nowrap text-sm leading-6 font-normal text-gray-900 truncate max-w-xs" :title="proyecto.descripcion">
                  ...
                  <span class="px-2 py-1 rounded-full text-xs font-semibold"
                    :class="{
                      'bg-green-100 text-green-800': proyecto.estatus === 'Revisado por supervisor'  || proyecto.estatus === 'Aceptado',
                      'bg-red-100 text-red-800': proyecto.estatus === 'Rechazado por el supervisor' || proyecto.estatus === 'Cancelado',
                      'bg-blue-100 text-blue-800': proyecto.estatus === 'Nuevo'
                    }"
                  >
                    {{ proyecto.estatus }}
                  </span>
                ...
                <td class="p-5">
                  <div class="flex items-center gap-1">
										<button class="p-2 rounded-full group transition-all duration-500 flex item-center hover:bg-green-100" title="Aprobar">
										...
										<button class="p-2 rounded-full group transition-all duration-500 flex item-center hover:bg-orange-100" title="Rechazar">
											<svg class="cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
